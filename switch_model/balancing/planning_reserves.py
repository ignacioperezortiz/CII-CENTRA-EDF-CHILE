...
def define_components(model):
    ...
    def AvailableReserveCapacity_rule(m, prr, t):
        ...
        TES_GENS = getattr(m, "TES_GENS", set())                                       # nuevo para habilitar TES como reserva...
        CSP_GENS = getattr(m, "CSP_GENS", set()) 
        for g in GENS:
            ...
            elif g in TES_GENS:                                                             # nuevo para habilitar TES como reserva... 
               reserve_cap += m.DispatchGen[g, t] - m.ChargeTES[g, t]
            elif g in CSP_GENS:                                                             # nuevo para habilitar TES como reserva... 
               reserve_cap += m.DispatchGen[g, t] - m.ChargeTESCSP[g, t]

...
for scenario in scenarios
    ...
    pivot_df_energy = pivot_df_energy[!, [:"8.0", :"10.0", :"14.0", :"24.0"]]
    pivot_df_capacity = pivot_df_capacity[!, [:"8.0", :"10.0", :"14.0", :"24.0"]]

    rename!(pivot_df_energy, Dict(Symbol("8.0") => Symbol("8"), Symbol("10.0") => Symbol("10"), Symbol("14.0") => Symbol("14"), Symbol("24.0") => Symbol("24")))
    rename!(pivot_df_capacity, Dict(Symbol("8.0") => Symbol("8"), Symbol("10.0") => Symbol("10"), Symbol("14.0") => Symbol("14"), Symbol("24.0") => Symbol("24")))
    ...
    width = 0.4  # Ancho de cada barra (aumentado)
    ...
    save(joinpath(scenario, "bomb_bar_chart_storage_energy.png"), fig_energy)
    ...
    # Guardar la figura en la ruta especificada
    save(joinpath(scenario, "bomb_bar_chart_installed_capacity.png"), fig_capacity)

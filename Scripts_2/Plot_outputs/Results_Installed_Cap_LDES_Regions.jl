...
for scenario in scenarios
    ...
    for region in load_zones
        ...
        save(joinpath(scenario, "RegionsLDES/"*replace(region, r"\s+" => "")*"_Storage_Icap_stacked_area_chart_MW.png"), fig_mw)
        ...
        # Guardar la figura en la ruta especificada
        save(joinpath(scenario, "RegionsLDES/"*replace(region, r"\s+" => "")*"_Storage_Icap_stacked_area_chart_MWh.png"), fig_mwh)
